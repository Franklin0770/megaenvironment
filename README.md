...
Then I decided that VS Code's integration would have opened the possibility to make a decent UI. As a matter of fact, if you hop on GitHub and take a look at the branches of this project, you can see there's an extremely early version that was rewritten shortly after the LUA conversion. As you can see in this accidentally snapped screenshot (now that I'm remembering it may have been to show my work off to a friend), I was trying to get the assemble command to work via the shell. The date is 30 November 2024. Very much incomplete, huh?  
![The Friend Flex](https://raw.githubusercontent.com/Franklin0770/megaenvironment/main/papers/OldLua.png)
